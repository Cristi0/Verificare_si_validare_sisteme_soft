...
public class ModifyProductController implements Initializable, Controller {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //this function is needed to initialize
    }
    ...
    void handleDeleteProduct(ActionEvent event) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            ApplicationLogger.log(Level.INFO,"Canceled part deletion.");
        }
    }
    ...
    void handleCancelProduct(ActionEvent event) throws IOException {
        ...
        Optional<ButtonType> result = alert.showAndWait();
        if(result.isPresent() && result.get() == ButtonType.OK) {
            ApplicationLogger.log(Level.INFO,"Ok selected. Product modification canceled.");
    ...
    void handleSaveProduct(ActionEvent event) throws IOException {
        ...
        try {
            ...
            ApplicationLogger.log(Level.INFO, "Form contains blank field.");
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
